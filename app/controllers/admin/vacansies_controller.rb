...
class Admin::VacansiesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Vacansy: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Vacansy: create, read, update, custom_action_for_an_item
  #
